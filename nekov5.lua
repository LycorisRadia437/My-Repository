--// Universal Roblox Compatibility Layer (2026)
...
-- wait() fix cho Roblox mới
local oldWait = wait
getfenv().wait = function(t)
    return task.wait(t or 0)
end

-- sethiddenproperty fallback
if not sethiddenproperty then
    getfenv().sethiddenproperty = function() end
end

-- getconnections fallback
if not getconnections then
    getfenv().getconnections = function()
        return {}
    end
end
