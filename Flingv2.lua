-- Modernized Touch Fling + Anti-Fling GUI (FIXED DRAG & VOID BUG)
...
-- LOGIC KÉO GUI MỚI (CHỐNG BỊ DÍNH MÀN HÌNH MÁY TÍNH & MOBILE)
...
-- Ngắt ngay trạng thái kéo khi thả ngón tay/chuột ra ở bất kỳ vị trí nào
...
-- LOGIC FLING (Ổn định không rơi map)
	...
	task.spawn(function()
		...
		while isFlinging do
			...
			if hrp and hum and hum.Health > 0 then
				...
				hrp.AssemblyLinearVelocity = Vector3.new(0, 9999999999999999999999999999999999999, 0)
				hrp.AssemblyAngularVelocity = Vector3.new(0, 9999999999999999999999999999999999999, 0)
...
-- LOGIC ANTI-FLING (Tắt va chạm CanCollide)
...
-- Tự động kích hoạt lại khi Respawn
